...
country = {
	...
	COLONIAL_RANK = 18, -- Minimum rank a nation must have to send colonists
	...
	COLONY_FORMED_PRESTIGE = 3, -- prestige from founding a colony.
	...
	UNCIV_TECH_SPREAD_MAX = 0.3, --Max techs an unciv will get on westernizing
...
military = {
	...
	LEADER_TRANSFER_PENALTY_ON_COUNTRY_PRESTIGE = 0.005, -- country prestige penalty on unassign leader (f.ex if leader has 100% prestige, the country loose 4% of its prestige)
...
diplomacy = {
	...
	PRESTIGE_GUNBOAT = 0.05, -- Prestige for debt collection
	PRESTIGE_INSTALL_COMMUNIST_GOV_TYPE = 0.1,
	PRESTIGE_UNINSTALL_COMMUNIST_GOV_TYPE = 0.05,
	PRESTIGE_COLONY = 0.05,
	...
	LIBERATE_STATE_RELATION_INCREASE = 200,
	...
	SPHERE_NEIGHBOUR_BONUS_INFLUENCE_PERCENT = 0.45, -- Bonus to countries in your sphere neighbouring when influencing
	OTHER_CONTINENT_BONUS_INFLUENCE_PERCENT = -0.50, -- Malus to countries in another continent
	PUPPET_BONUS_INFLUENCE_PERCENT = 1000, -- bonus if they are our puppet
	...
	GW_WARGOAL_JINGOISM_REQUIREMENT_MOD = 0.75, -- % deduction of required jingoists in country
...
pops = {
	...
	REDUCTION_AFTER_RISEING = 0.33, -- After a pop spawns a rebellion, its militancy will be reduced this much
...
ai =
{
	...
	SPAM_PENALTY = 15, -- makes certain diplomatic action less common 
